...
import (
	...
	"github.com/knative/serving/pkg/reconciler/v1beta1/route/resources/names"
...
func MakeVirtualService(u *v1beta1.Route, tc *traffic.TrafficConfig) *v1alpha3.VirtualService {
...
func makeVirtualServiceSpec(u *v1beta1.Route, targets map[string][]traffic.RevisionTarget) v1alpha3.VirtualServiceSpec {
...
func getRouteDomains(targetName string, u *v1beta1.Route, domain string) []string {
	var domains []string
	if targetName == "" {
