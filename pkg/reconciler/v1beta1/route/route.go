...
func NewController(
	...
	serviceInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: controller.Filter(v1beta1.SchemeGroupVersion.WithKind("Route")),
...
func (c *Reconciler) reconcile(ctx context.Context, route *v1beta1.Route) error {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) configureTraffic(ctx context.Context, r *v1beta1.Route) (*v1beta1.Route, error) {
...
func (c *Reconciler) EnqueueReferringRoute(impl *controller.Impl) func(obj interface{}) {
	return func(obj interface{}) {
		config, ok := obj.(*v1beta1.Configuration)
		if !ok {
...
func (c *Reconciler) routeDomain(route *v1beta1.Route) string {
