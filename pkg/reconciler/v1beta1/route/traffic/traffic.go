...
func BuildTrafficConfiguration(configLister listers.ConfigurationLister, revLister listers.RevisionLister,
	u *v1beta1.Route) (*TrafficConfig, error) {
...
func (t *TrafficConfig) GetTrafficTargets() []v1beta1.TrafficTarget {
	results := []v1beta1.TrafficTarget{}
...
func newBuilder(configLister listers.ConfigurationLister, revLister listers.RevisionLister, namespace string) *trafficConfigBuilder {
	return &trafficConfigBuilder{
		...
		configurations: make(map[string]*v1beta1.Configuration),
		revisions:      make(map[string]*v1beta1.Revision),
	}
}

func (t *trafficConfigBuilder) getConfiguration(name string) (*v1beta1.Configuration, error) {
...
func (t *trafficConfigBuilder) getRevision(name string) (*v1beta1.Revision, error) {
...
func (t *trafficConfigBuilder) addTrafficTarget(tt *v1beta1.TrafficTarget) error {
	var err error
	if tt.RevisionName != "" {
...
func (t *trafficConfigBuilder) addConfigurationTarget(tt *v1beta1.TrafficTarget) error {
...
func (t *trafficConfigBuilder) addRevisionTarget(tt *v1beta1.TrafficTarget) error {
