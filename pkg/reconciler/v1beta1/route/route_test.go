...
import (
	...
	resourcenames "github.com/knative/serving/pkg/reconciler/v1beta1/route/resources/names"
...
func getTestRevision(name string) *v1beta1.Revision {
	return getTestRevisionWithCondition(name, v1beta1.RevisionCondition{
...
func getTestRevisionWithCondition(name string, cond v1beta1.RevisionCondition) *v1beta1.Revision {
	return &v1beta1.Revision{
		...
		Status: v1beta1.RevisionStatus{
			...
			Conditions:  []v1beta1.RevisionCondition{cond},
		},
	}
}
...
func addResourcesToInformers(
	...
	servingClient *fakeclientset.Clientset, servingInformer informers.SharedInformerFactory, route *v1beta1.Route) {
	t.Helper()

	ns := route.Namespace

	route, err := servingClient.ServingV1beta1().Routes(ns).Get(route.Name, metav1.GetOptions{})
	if err != nil {
...
func TestCreateRouteForOneReserveRevision(t *testing.T) {
	...
	rev := getTestRevisionWithCondition("test-rev",
		v1beta1.RevisionCondition{
			Type:   v1beta1.RevisionConditionActive,
...
func TestEnqueueReferringRoute(t *testing.T) {
	...
	routeClient := servingClient.ServingV1beta1().Routes(testNamespace)
...
func TestUpdateDomainConfigMap(t *testing.T) {
	...
	route := getTestRouteWithTrafficTargets([]v1beta1.TrafficTarget{})
