...
import (
	...
	servingv1alpha1 "github.com/knative/serving/pkg/client/clientset/versioned/typed/serving/v1beta1"
...
func (c *Reconciler) syncLabels(ctx context.Context, r *v1beta1.Route, tc *traffic.TrafficConfig) error {
...
func (c *Reconciler) setLabelForGivenConfigurations(
	ctx context.Context,
	route *v1beta1.Route,
	configMap map[string]*v1beta1.Configuration,
) error {
