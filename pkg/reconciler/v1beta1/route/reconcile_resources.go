...
func (c *Reconciler) reconcileVirtualService(ctx context.Context, route *v1beta1.Route,
...
func (c *Reconciler) reconcilePlaceholderService(ctx context.Context, route *v1beta1.Route) error {
	logger := logging.FromContext(ctx)
	ns := route.Namespace
...
func (c *Reconciler) updateStatus(ctx context.Context, route *v1beta1.Route) (*v1beta1.Route, error) {
