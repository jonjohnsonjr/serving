...
import (
	...
	"github.com/knative/serving/pkg/reconciler/v1beta1/route/config"
	"github.com/knative/serving/pkg/reconciler/v1beta1/route/resources"
	...
	. "github.com/knative/serving/pkg/reconciler/v1beta1/testing"
)
...
func TestReconcile(t *testing.T) {
	table := TableTest{{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "first-reconcile", "not-ready", &v1beta1.RouteStatus{
				Domain:         "first-reconcile.default.example.com",
				DomainInternal: "first-reconcile.default.svc.cluster.local",
				Conditions: []v1beta1.RouteCondition{{
					Type:    v1beta1.RouteConditionAllTrafficAssigned,
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "first-reconcile", "permanently-failed", &v1beta1.RouteStatus{
				Domain:         "first-reconcile.default.example.com",
				DomainInternal: "first-reconcile.default.svc.cluster.local",
				Conditions: []v1beta1.RouteCondition{{
					Type:    v1beta1.RouteConditionAllTrafficAssigned,
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "becomes-ready", "config", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "label-config-failure", "config", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "create-svc-failure", "config", &v1beta1.RouteStatus{
				Conditions: []v1beta1.RouteCondition{{
					Type:   v1beta1.RouteConditionAllTrafficAssigned,
					Status: corev1.ConditionUnknown,
				}, {
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "vs-create-failure", "config", &v1beta1.RouteStatus{
		...
		Name: "steady state",
		Objects: []runtime.Object{
			simpleRunLatest("default", "steady-state", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			addRouteLabel(
				simpleRunLatest("default", "different-domain", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "new-latest-created", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "new-latest-ready", "config", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			...
			Object: simpleRunLatest("default", "new-latest-ready", "config", &v1beta1.RouteStatus{
				Domain:         "new-latest-ready.default.example.com",
				DomainInternal: "new-latest-ready.default.svc.cluster.local",
				Conditions: []v1beta1.RouteCondition{{
					Type:   v1beta1.RouteConditionAllTrafficAssigned,
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "update-vs-failure", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "svc-mutation", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "cluster-ip", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "virt-svc-mutation", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "licked-cookie", "config", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			...
			simpleRunLatest("default", "change-configs", "newconfig", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			...
			Object: simpleRunLatest("default", "change-configs", "newconfig", &v1beta1.RouteStatus{
				Domain:         "change-configs.default.example.com",
				DomainInternal: "change-configs.default.svc.cluster.local",
				Conditions: []v1beta1.RouteCondition{{
					Type:   v1beta1.RouteConditionAllTrafficAssigned,
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "config-missing", "not-found", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simplePinned("default", "missing-revision-direct", "not-found", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simpleRunLatest("default", "missing-revision-indirect", "config", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: simplePinned("default", "pinned-becomes-ready",
				...
				simpleReadyConfig("default", "config").Status.LatestReadyRevisionName, &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: routeWithTraffic("default", "named-traffic-split", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "switch-configs", "green", &v1beta1.RouteStatus{
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			...
			Object: simpleRunLatest("default", "switch-configs", "green", &v1beta1.RouteStatus{
				Domain:         "switch-configs.default.example.com",
				DomainInternal: "switch-configs.default.svc.cluster.local",
				Conditions: []v1beta1.RouteCondition{{
					Type:   v1beta1.RouteConditionAllTrafficAssigned,
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "rmlabel-config-failure", "green", &v1beta1.RouteStatus{
		...
		Objects: []runtime.Object{
			simpleRunLatest("default", "addlabel-config-failure", "green", &v1beta1.RouteStatus{
...
func routeWithTraffic(namespace, name string, status *v1beta1.RouteStatus, traffic ...v1beta1.TrafficTarget) *v1beta1.Route {
	route := &v1beta1.Route{
...
func simplePinned(namespace, name, revision string, status *v1beta1.RouteStatus) *v1beta1.Route {
	return routeWithTraffic(namespace, name, status, v1beta1.TrafficTarget{
		RevisionName: revision,
		Percent:      100,
	})
}

func simpleRunLatest(namespace, name, config string, status *v1beta1.RouteStatus) *v1beta1.Route {
	return routeWithTraffic(namespace, name, status, v1beta1.TrafficTarget{
		ConfigurationName: config,
		Percent:           100,
	})
...
func setDomain(route *v1beta1.Route, domain string) *v1beta1.Route {
	route.Status.Domain = domain
	return route
}

func simpleNotReadyConfig(namespace, name string) *v1beta1.Configuration {
...
func simpleFailedConfig(namespace, name string) *v1beta1.Configuration {
	cfg := &v1beta1.Configuration{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: namespace,
			Name:      name,
...
func simpleReadyConfig(namespace, name string) *v1beta1.Configuration {
	return setLatestReadyRevision(simpleNotReadyConfig(namespace, name))
}

func setLatestCreatedRevision(cfg *v1beta1.Configuration, name string) *v1beta1.Configuration {
	cfg.Status.SetLatestCreatedRevisionName(name)
	return cfg
}

func setLatestReadyRevision(cfg *v1beta1.Configuration) *v1beta1.Configuration {
	cfg.Status.SetLatestReadyRevisionName(cfg.Status.LatestCreatedRevisionName)
	return cfg
}

func addRouteLabel(route *v1beta1.Route, key, value string) *v1beta1.Route {
	if route.Labels == nil {
...
func addConfigLabel(config *v1beta1.Configuration, key, value string) *v1beta1.Configuration {
...
func simpleReadyRevision(namespace, name string) *v1beta1.Revision {
	return &v1beta1.Revision{
		...
		Status: v1beta1.RevisionStatus{
			Conditions: []v1beta1.RevisionCondition{{
				Type:   v1beta1.RevisionConditionReady,
				Status: corev1.ConditionTrue,
			}},
		},
	}
...
func simpleNotReadyRevision(namespace, name string) *v1beta1.Revision {
	return &v1beta1.Revision{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: namespace,
			Name:      name,
...
func simpleFailedRevision(namespace, name string) *v1beta1.Revision {
	return &v1beta1.Revision{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: namespace,
			Name:      name,
...
func addOwnerRef(rev *v1beta1.Revision, o []metav1.OwnerReference) *v1beta1.Revision {
