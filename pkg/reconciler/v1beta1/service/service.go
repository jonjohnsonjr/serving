...
import (
	...
	resourcenames "github.com/knative/serving/pkg/reconciler/v1beta1/service/resources/names"
)
...
func NewController(
	...
	configurationInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: controller.Filter(v1beta1.SchemeGroupVersion.WithKind("Service")),
...
func (c *Reconciler) reconcile(ctx context.Context, service *v1beta1.Service) error {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) updateStatus(service *v1beta1.Service) (*v1beta1.Service, error) {
...
func (c *Reconciler) createConfiguration(service *v1beta1.Service) (*v1beta1.Configuration, error) {
