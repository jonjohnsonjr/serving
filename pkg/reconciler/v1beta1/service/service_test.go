...
import (
	...
	"github.com/knative/serving/pkg/reconciler/v1beta1/service/resources"
...
var (
	boolTrue   = true
	configSpec = v1beta1.ConfigurationSpec{
	...
	initialConditions = []v1beta1.ServiceCondition{{
		Type:   v1beta1.ServiceConditionConfigurationsReady,
		Status: corev1.ConditionUnknown,
	}, {
		Type:   v1beta1.ServiceConditionReady,
		Status: corev1.ConditionUnknown,
	}, {
		Type:   v1beta1.ServiceConditionRoutesReady,
		Status: corev1.ConditionUnknown,
	}}
)
...
func TestReconcile(t *testing.T) {
	table := TableTest{{
		...
		Objects: []runtime.Object{
			...
			svc("incomplete", "foo", v1beta1.ServiceSpec{}, initialConditions...),
		},
		Key:     "foo/incomplete",
		WantErr: true,
	}, {
		...
		Objects: []runtime.Object{
			...
			svc("bad-config-update", "foo", v1beta1.ServiceSpec{}, initialConditions...),
			// Update the skeletal Config/Route to have the appropriate {Config,Route}Specs
		...
		Objects: []runtime.Object{
			...
			cfgWithStatus(mustMakeConfig(t, svcRL("all-ready", "foo", initialConditions...)),
				v1beta1.ConfigurationStatus{
					Conditions: []v1beta1.ConfigurationCondition{{
		...
		Key: "foo/all-ready",
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: svcRL("all-ready", "foo", []v1beta1.ServiceCondition{{
				Type:   v1beta1.ServiceConditionConfigurationsReady,
				Status: corev1.ConditionTrue,
			}, {
				Type:   v1beta1.ServiceConditionReady,
		...
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: svcRL("config-fails", "foo", []v1beta1.ServiceCondition{{
				Type:   v1beta1.ServiceConditionConfigurationsReady,
				Status: corev1.ConditionFalse,
				Reason: "Propagate me, please",
			}, {
		...
		Key: "foo/route-fails",
		WantUpdates: []clientgotesting.UpdateActionImpl{{
			Object: svcRL("route-fails", "foo", []v1beta1.ServiceCondition{{
				Type:   v1beta1.ServiceConditionConfigurationsReady,
				Status: corev1.ConditionTrue,
			}, {
				Type:   v1beta1.ServiceConditionReady,
...
func svc(name, namespace string, spec v1beta1.ServiceSpec, conditions ...v1beta1.ServiceCondition) *v1beta1.Service {
...
func svcRL(name, namespace string, conditions ...v1beta1.ServiceCondition) *v1beta1.Service {
	return svc(name, namespace, v1beta1.ServiceSpec{
		RunLatest: &v1beta1.RunLatestType{Configuration: configSpec},
	}, conditions...)
}

func svcPin(name, namespace string, conditions ...v1beta1.ServiceCondition) *v1beta1.Service {
	return svc(name, namespace, v1beta1.ServiceSpec{
		Pinned: &v1beta1.PinnedType{RevisionName: "pinned-0001", Configuration: configSpec},
	}, conditions...)
}

func mustMakeConfig(t *testing.T, svc *v1beta1.Service) *v1beta1.Configuration {
...
func mutateConfig(cfg *v1beta1.Configuration) *v1beta1.Configuration {
	cfg.Spec = v1beta1.ConfigurationSpec{}
	return cfg
}

// mutateRoute mutates the specification of the Route to simulate someone editing it around our controller.
func mutateRoute(rt *v1beta1.Route) *v1beta1.Route {
	rt.Spec = v1beta1.RouteSpec{}
	return rt
}

// TODO(#1762): Replace with builders.
func cfgWithStatus(cfg *v1beta1.Configuration, s v1beta1.ConfigurationStatus) *v1beta1.Configuration {
	cfg.Status = s
	return cfg
}

// TODO(#1762): Replace with builders.
func routeWithStatus(rt *v1beta1.Route, s v1beta1.RouteStatus) *v1beta1.Route {
	rt.Status = s
	return rt
}
