...
import (
	...
	"github.com/knative/serving/pkg/reconciler/v1beta1/configuration/resources"
...
func cfgWithBuildAndStatus(name, namespace string, generation int64, build *buildv1alpha1.BuildSpec, status v1beta1.ConfigurationStatus) *v1beta1.Configuration {
...
func cfgWithStatus(name, namespace string, generation int64, status v1beta1.ConfigurationStatus) *v1beta1.Configuration {
	return cfgWithBuildAndStatus(name, namespace, generation, nil, status)
}

func cfgWithBuild(name, namespace string, generation int64, build *buildv1alpha1.BuildSpec) *v1beta1.Configuration {
	return cfgWithBuildAndStatus(name, namespace, generation, build, v1beta1.ConfigurationStatus{})
}

func cfg(name, namespace string, generation int64) *v1beta1.Configuration {
	return cfgWithStatus(name, namespace, generation, v1beta1.ConfigurationStatus{})
}

func setConcurrencyModel(cfg *v1beta1.Configuration, ss v1beta1.RevisionRequestConcurrencyModelType) *v1beta1.Configuration {
	cfg.Spec.RevisionTemplate.Spec.ConcurrencyModel = ss
	return cfg
}

func setRevConcurrencyModel(rev *v1beta1.Revision, ss v1beta1.RevisionRequestConcurrencyModelType) *v1beta1.Revision {
	rev.Spec.ConcurrencyModel = ss
	return rev
}

func makeRevReady(t *testing.T, rev *v1beta1.Revision) *v1beta1.Revision {
...
func makeRevFailed(rev *v1beta1.Revision) *v1beta1.Revision {
	rev.Status.InitializeConditions()
	rev.Status.MarkContainerMissing("It's the end of the world as we know it")
	return rev
}

func makeRevStatus(rev *v1beta1.Revision, status v1beta1.RevisionStatus) *v1beta1.Revision {
	rev.Status = status
	return rev
}
