...
import (
	...
	resourcenames "github.com/knative/serving/pkg/reconciler/v1beta1/configuration/resources/names"
	"go.uber.org/zap"
...
func NewController(
	...
	revisionInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: controller.Filter(v1beta1.SchemeGroupVersion.WithKind("Configuration")),
...
func (c *Reconciler) reconcile(ctx context.Context, config *v1beta1.Configuration) error {
	logger := logging.FromContext(ctx)
	...
	rc := latestCreatedRevision.Status.GetCondition(v1beta1.RevisionConditionReady)
	switch {
...
func (c *Reconciler) createRevision(ctx context.Context, config *v1beta1.Configuration, revName string) (*v1beta1.Revision, error) {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) updateStatus(u *v1beta1.Configuration) (*v1beta1.Configuration, error) {
