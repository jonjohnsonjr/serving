...
func MakeFluentdConfigMap(rev *v1beta1.Revision, observabilityConfig *config.Observability) *corev1.ConfigMap {
...
func makeFluentdContainer(rev *v1beta1.Revision, observabilityConfig *config.Observability) *corev1.Container {
	configName := ""
