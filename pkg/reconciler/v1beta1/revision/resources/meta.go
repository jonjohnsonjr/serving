...
func makeLabels(revision *v1beta1.Revision) map[string]string {
...
func makeSelector(revision *v1beta1.Revision) *metav1.LabelSelector {
...
func makeAnnotations(revision *v1beta1.Revision) map[string]string {
