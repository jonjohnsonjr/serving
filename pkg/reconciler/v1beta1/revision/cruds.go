...
func (c *Reconciler) createDeployment(ctx context.Context, rev *v1beta1.Revision) (*appsv1.Deployment, error) {
...
type serviceFactory func(*v1beta1.Revision) *corev1.Service

func (c *Reconciler) createService(ctx context.Context, rev *v1beta1.Revision, sf serviceFactory) (*corev1.Service, error) {
	// Create the service.
	service := sf(rev)
...
func (c *Reconciler) checkAndUpdateService(ctx context.Context, rev *v1beta1.Revision, sf serviceFactory, service *corev1.Service) (*corev1.Service, Changed, error) {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) createVPA(ctx context.Context, rev *v1beta1.Revision) (*vpav1alpha1.VerticalPodAutoscaler, error) {
