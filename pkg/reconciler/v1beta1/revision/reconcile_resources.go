...
import (
	...
	resourcenames "github.com/knative/serving/pkg/reconciler/v1beta1/revision/resources/names"
...
func (c *Reconciler) reconcileDeployment(ctx context.Context, rev *v1beta1.Revision) error {
	ns := rev.Namespace
...
func (c *Reconciler) reconcileKPA(ctx context.Context, rev *v1beta1.Revision) error {
	ns := rev.Namespace
...
func (c *Reconciler) reconcileService(ctx context.Context, rev *v1beta1.Revision) error {
	ns := rev.Namespace
...
func (c *Reconciler) reconcileFluentdConfigMap(ctx context.Context, rev *v1beta1.Revision) error {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) reconcileVPA(ctx context.Context, rev *v1beta1.Revision) error {
	logger := logging.FromContext(ctx)
