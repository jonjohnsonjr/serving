...
func (f *Listers) GetServiceLister() servinglisters.ServiceLister {
	return servinglisters.NewServiceLister(f.indexerForType(&v1beta1.Service{}))
}

func (f *Listers) GetRouteLister() servinglisters.RouteLister {
	return servinglisters.NewRouteLister(f.indexerForType(&v1beta1.Route{}))
}

func (f *Listers) GetConfigurationLister() servinglisters.ConfigurationLister {
	return servinglisters.NewConfigurationLister(f.indexerForType(&v1beta1.Configuration{}))
}

func (f *Listers) GetRevisionLister() servinglisters.RevisionLister {
	return servinglisters.NewRevisionLister(f.indexerForType(&v1beta1.Revision{}))
}
