...
import (
	...
	kpa "github.com/knative/serving/pkg/apis/autoscaling/v1beta1"
	"github.com/knative/serving/pkg/apis/serving/v1beta1"
	clientset "github.com/knative/serving/pkg/client/clientset/versioned"
	fakeKna "github.com/knative/serving/pkg/client/clientset/versioned/fake"
	revisionresources "github.com/knative/serving/pkg/reconciler/v1beta1/revision/resources"
	"github.com/knative/serving/pkg/reconciler/v1beta1/revision/resources/names"
	"k8s.io/api/apps/v1"
...
func TestKPAScaler(t *testing.T) {
	examples := []struct {
		label         string
		startState    v1beta1.RevisionServingStateType
		startReplicas int
		scaleTo       int32
		wantState     v1beta1.RevisionServingStateType
		wantReplicas  int
		wantScaling   bool
		kpaMutation   func(*kpa.PodAutoscaler)
	}{{
		label:         "waits to scale to zero (fresh)",
		startState:    v1beta1.RevisionServingStateReserve,
		startReplicas: 1,
		scaleTo:       0,
		wantState:     v1beta1.RevisionServingStateReserve,
		wantReplicas:  1,
		wantScaling:   false,
		...
		label:         "scales up",
		startState:    v1beta1.RevisionServingStateActive,
		startReplicas: 1,
		scaleTo:       10,
		wantState:     v1beta1.RevisionServingStateActive,
		wantReplicas:  10,
		wantScaling:   true,
	}, {
...
func newRevision(t *testing.T, servingClient clientset.Interface, servingState v1beta1.RevisionServingStateType) *v1beta1.Revision {
...
func newDeployment(t *testing.T, scaleClient *scalefake.FakeScaleClient, revision *v1beta1.Revision, replicas int) *v1.Deployment {
