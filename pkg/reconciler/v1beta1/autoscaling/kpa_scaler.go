...
func (rs *kpaScaler) Scale(ctx context.Context, kpa *kpa.PodAutoscaler, desiredScale int32) error {
	...
	revGVK := v1beta1.SchemeGroupVersion.WithKind("Revision")
	...
	if kpa.Spec.ServingState == v1beta1.RevisionServingStateActive && desiredScale == 0 {
		logger.Debug("Setting revision ServingState to Reserve.")
		rev.Spec.ServingState = v1beta1.RevisionServingStateReserve
	...
	// things to zero.
	if kpa.Spec.ServingState != v1beta1.RevisionServingStateActive {
